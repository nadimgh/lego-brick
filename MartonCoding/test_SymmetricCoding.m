%testing script for symmetric coding (without precoding) over a two-user broadcast channel
...
rate_cell = getMaximumAchievableUserRates(H, P_dB, 'symmetric');
rate = getUserRates(sum_rate, rate_cell, 'symmetric');
